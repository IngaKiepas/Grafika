...
const Triangle = function () {
    ...
    const wall= 2.0; // dlugosc boku

    var boxVertices = 
	[ // X, Y, Z           R, G, B
		// Top
		-wall/2, wall/2, -wall/2,  0.5, 0.5, 0.5,
		-wall/2, wall/2, wall/2,   0.5, 0.5, 0.5,
		wall/2, wall/2, wall/2,    0.5, 0.5, 0.5,
		wall/2, wall/2, -wall/2,   0.5, 0.5, 0.5,

		// Left
		-wall/2, wall/2, wall/2,    0.75, 0.25, 0.5,
		-wall/2, -wall/2, wall/2,   0.75, 0.25, 0.5,
		-wall/2, -wall/2, -wall/2,  0.75, 0.25, 0.5,
		-wall/2, wall/2, -wall/2,   0.75, 0.25, 0.5,

		// Right
		wall/2, wall/2, wall/2,    0.25, 0.25, 0.75,
		wall/2, -wall/2, wall/2,   0.25, 0.25, 0.75,
		wall/2, -wall/2, -wall/2,  0.25, 0.25, 0.75,
		wall/2, wall/2, -wall/2,   0.25, 0.25, 0.75,

		// Front
		wall/2, wall/2, wall/2,    1.0, 0.0, 0.15,
		wall/2, -wall/2, wall/2,   1.0, 0.0, 0.15,
		-wall/2, -wall/2, wall/2,  1.0, 0.0, 0.15,
		-wall/2, wall/2, wall/2,   1.0, 0.0, 0.15,

		// Back
		wall/2, wall/2, -wall/2,    0.0, 1.0, 0.15,
		wall/2, -wall/2, -wall/2,   0.0, 1.0, 0.15,
		-wall/2, -wall/2, -wall/2,  0.0, 1.0, 0.15,
		-wall/2, wall/2, -wall/2,   0.0, 1.0, 0.15,

		// Bottom
		-wall/2, -wall/2, -wall/2,   0.5, 0.5, 1.0,
		-wall/2, -wall/2, wall/2,    0.5, 0.5, 1.0,
		wall/2, -wall/2, wall/2,     0.5, 0.5, 1.0,
		wall/2, -wall/2, -wall/2,    0.5, 0.5, 1.0,
	];
